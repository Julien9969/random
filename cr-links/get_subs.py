...
try:
    ...
    pass
aniDL_path = "C:/Users/69juj/Desktop/CODE/random/cr-links/anidl/aniDL.exe"
...
while True:
    ...
    sub = subprocess.Popen(f"{aniDL_path} --service crunchy --series {id} --allDubs --novids --all --waittime 50000", shell=True)
    # time.sleep(5)
    sub.wait()
